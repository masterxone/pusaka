...
# LINK REPO
REPO="https://raw.githubusercontent.com/masterxone/pusaka/main/autoscript/"
start=$(date +%s)
...
clear
MYIP=$(curl -sS ipv4.icanhazip.com)
izinsc="https://raw.githubusercontent.com/masterxone/pusaka/main/autoscript/sogokregister"
rm -f /usr/bin/user
...
TIMES="10"
CHATID="6348824977"
KEY="6661701915:AAEO8F3w4ef9ywqnG3YGntgmblUTsSCRuLI"
URL="https://api.telegram.org/bot$KEY/sendMessage"
TIMEZONE=$(printf '%(%H:%M:%S)T')
TEXT="
<code>──────────────────────────</code>
<code>Install Special Autoscript V2.4</code>
<code>──────────────────────────</code>
...
<code>──────────────────────────</code>
<code>Created By Gemilangkinasih $(date +%Y)</code>
<code>──────────────────────────</code>
